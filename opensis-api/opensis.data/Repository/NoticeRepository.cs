...
namespace opensis.data.Repository
{
    public class NoticeRepository : INoticeRepository
    {
        ...
        public NoticeListViewModel GetAllNotice(NoticeListViewModel noticeList)
        {
            ...
            try
            {
                var noticeRepository = this.context?.Notice.OrderBy(x => x.ValidFrom).Where(x => x.TenantId == noticeList.TenantId && (x.SchoolId == noticeList.SchoolId || x.VisibleToAllSchool == true)  && x.Isactive == true ).ToList();
