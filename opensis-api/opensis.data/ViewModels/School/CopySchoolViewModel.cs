...
namespace opensis.data.ViewModels.School
{
    public class CopySchoolViewModel : CommonFields
    {
        ...
        public bool? SchoolCalendar { get; set; }
        ...
        public bool? CalenderCourse { get; set; }
        ...
        public bool? FemaleToiletAccessories { get; set; }
        public bool? MaleToiletType { get; set; }
        public bool? MaleToiletAccessories { get; set; }
        public bool? CommonToiletType { get; set; }
        public bool? CommonToiletAccessories { get; set; }
